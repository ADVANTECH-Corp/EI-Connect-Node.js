...
var strWillTopic = '/cagent/admin/<clientid>/willmessage';	/*publish*/
var strInfoAckTopic = '/cagent/admin/<clientid>/agentinfoack';	/*publish*/
var strDataReportTopic = '/cagent/admin/<clientid>/devinfo';	/*publish*/

var strActionAckTopic = '/cagent/admin/<clientid>/agentactionack';	/*publish '/wisepaas/<custom>/<devId>/agentactionack'*/
var strEventNotifyTopic = '/cagent/admin/<clientid>/eventnotify';	/*publish '/wisepaas/<custom>/<devId>/eventnotifyack'*/
var strActionReqTopic = '/cagent/admin/<clientid>/agentcallbackreq';	/*Subscrib '/wisepaas/<custom>/<devId>/agentactionreq'e*/
var strAgentCtrlTopic = '/cagent/admin/+/agentctrlreq';	/*Subscribe*/
var strHeartbeatTopic = '/cagent/admin/<clientid>/notify';	/*publish*/

var strAgentInfo = '{"susiCommData":{"devID":"<clientid>","parentID":"<parentid>","hostname":"<hostname>","sn":"<sn>","mac":"<mac>","version":"<version>","type":"<type>","product":"<product>","manufacture":"<manufacture>","account":"<account>","passwd":"<passwd>","status":<status>,"tag":"<tag>","commCmd":1,"agentID":"<clientid>","handlerName":"general","sendTS":{"$date":<ts>}}}';
var strGeneralResponse_Session = '{"susiCommData":{"agentID":"<clientid>","commCmd":<cmd>,"handlerName":"general","result":"<result>","sessionID":"<session>","sendTS":{"$date":<ts>}}}';
var strGeneralResponse = '{"susiCommData":{"agentID":"<clientid>","commCmd":<cmd>,"handlerName":"general",“result":"<result>","sendTS":{"$date":<ts>}}}';
var strReportData = '{"susiCommData":{"agentID":"<clientid>","commCmd":2055,"handlerName":"general","data":<content>,"sendTS":{"$date":<ts>}}}';
var strActResponse = '{"susiCommData":{"agentID":"<clientid>","commCmd":<cmd>,"handlerName":"<handler>",<content>,"sendTS":{"$date":<ts>}}}';
var strHeartbeat = '{"hb":{"devID":"<clientid>"}}';
var strHeartbeatResponse_Session = '{"susiCommData":{"agentID":"<clientid>","commCmd":128,"handlerName":"general","heartbeatrate":<heartbeatrate>,"sessionID":"<session>","sendTS":{"$date":<ts>}}}';
var strHeartbeatResponse = '{"susiCommData":{"agentID":"<clientid>","commCmd":128,"handlerName":"general","heartbeatrate":<heartbeatrate>,"sendTS":{"$date":<ts>}}}';

/**
 * SouthBound - Southbound constructor of EdgeSense .
 *  
 * @api public
 * @example var client = new WISECore();
 */
var SouthBound = function () {
	this.core_contex = {};
...
/**
 * core_initialize - initialize the SouthBound.
 *
 ...
 */
SouthBound.prototype.core_initialize = function (strClientID, strHostName, strMAC, userdata) {
...
/**
 * core_uninitialize - uninitialize the SouthBound.
 *
 * @api public
 * @example client.core_uninitialize();
 */
SouthBound.prototype.core_uninitialize = function () {
 ...
 */
SouthBound.prototype.core_tag_set = function (strTag) {
 ...
 */
SouthBound.prototype.core_product_info_set = function (strSerialNum, strParentID, strVersion, strType, strProduct, strManufacture) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_account_bind = function (strLoginID, strLoginPW) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_connection_callback_set = function (on_connect, on_lostconnect, on_disconnect, on_msg_recv) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 *    {Object} userdata - the user data attached in the SouthBound.
 ...
 */
SouthBound.prototype.core_action_callback_set = function (on_rename, on_update) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_server_reconnect_callback_set = function (on_server_reconnect) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_iot_callback_set = function (on_get_capability, on_start_report, on_stop_report) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_time_tick_callback_set = function (on_get_timetick) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_heartbeat_callback_set = function (on_query_heartbeatrate, on_update_heartbeatrate) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_action_response = function (iCmdid, strSessoinid, bSuccess, strClientid) {
	if (!this.core_contex.bInited) {
		return false;
	}
	...
	var strtopic = strActionAckTopic.replace('<clientid>', strClientid);
 ...
 */
SouthBound.prototype.core_heartbeatratequery_response = function (iHeartbeatRate, strSessoinid, strClientid) {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (!this.core_contex.Client) {
 ...
 */
SouthBound.prototype.core_tls_set = function (strCaFile, strCaPath, strCertFile, strKeyFile, strCerPasswd) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_tls_psk_set = function (strPsk, strIdentity, strCiphers) {
	if (!this.core_contex.bInited) {
		return false;
	}
 ...
 */
SouthBound.prototype.core_connect = function (strServerIP, iServerPort, strConnID, strConnPW) {
 ...
 */
SouthBound.prototype.core_disconnect = function (bForce) {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (this.core_contex.Client != null) {
 ...
 */
SouthBound.prototype.core_device_register = function () {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (this.core_contex.Client == null) {
	...
	this.core_contex.Client.subscribe([
		strActionReqTopic.replace('<clientid>', this.core_contex.strClientID),
		strAgentCtrlTopic]);
 ...
 */
SouthBound.prototype.core_heartbeat_send = function () {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (this.core_contex.Client == null) {
 ...
 */
SouthBound.prototype.core_publish = function (strTopic, strPkt, bRetain, iQos, callback) {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (this.core_contex.Client == null) {
 ...
 * @example client.subscribe('topic', 0, console.log);
  */
SouthBound.prototype.core_subscribe = function (strTopic, iQos, callback) {
	if (!this.core_contex.bInited) {
		return false;
	}
	if (this.core_contex.Client == null) {
...
function GenAgentInfo(core_context, timetick, status) {
	return strAgentInfo.replace('<parentid>', core_context.strParentID == null ? '' : core_context.strParentID)
		...
		.replace(/<clientid>/g, core_context.strClientID)
		.replace('<ts>', timetick);
}
...
function On_Recv(core_contex, topic, payload, packet) {
	var bHandled = false;
	if (topic.indexOf('/cagent/admin/') < 0) {
	...
	var body = root['susiCommData'];

	if (body == null)
		return;

	if (body['handlerName'] != 'general') {
		return call_external_msg_recv(core_contex, topic, payload, packet);
	}
	...
	switch (body['commCmd']) {
		...
		case CommCmd.wise_server_control_req:
			{
				var iStatusCode = body['response']['statuscode'];
				if(iStatusCode == 4){
		...
		case CommCmd.wise_heartbeatrate_query_req:
			if(core_contex.on_query_heartbeatrate != null) {
				var strSessionID = body['sessionID'];
...
function On_Update(core_contex, root) {
	var strUserName = root['susiCommData']['userName'];
	var strPwd = root['susiCommData']['pwd'];
	var strSessionID = root['susiCommData']['sessionID'];
	var iPort = root['susiCommData']['port'];
	var strPath = root['susiCommData']['path'];
	var strMD5 = root['susiCommData']['md5'];
...
function On_Rename(core_contex, root) {
	var strName = root['susiCommData']['devName'];
	var strSessionID = root['susiCommData']['sessionID'];
